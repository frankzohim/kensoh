...
@section('title',__('Liste des coupons'))
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">coupons</li></a>
       ...
       <div class="container-fluid">
                <div class="card">
                    ...
                    <div class="btn-popup pull-right">
                        <a href='{{route("coupon.create")}}'><button type="button" class="btn btn-primary">Ajouter Un Coupon</button></a>
                    </div>
                            ...
                            @foreach($coupons as $coupon)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('coupon.destroy',['coupon' => $coupon->id]) }}" data-bs-toggle="modal" data-original-title="test" data-bs-target="#exampleModal{{$coupon->id}}"><i class="fa fa-trash font-danger"></i></a>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form method="POST" action="{{ route('coupon.destroy',['coupon' => $coupon->id]) }}" id="delete-form{{$coupon->id}}">
                                                    @csrf
