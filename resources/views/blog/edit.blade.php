@extends('layouts.app')
@section('title', __('Editer une actualité'))
...
@section('content')
            ...
            <!-- Container-fluid starts-->
            <div class="container-fluid">
            <form method="post" action="{{route('blog.update', $blog->id)}}"  id="singleFileUpload" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <!-- Validation Errors -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="m-checkbox-inline mb-0 custom-radio-ml d-flex radio-animated">
                                                <label class="d-block" for="edo-ani">
                                                    ...
                                                    id="state" type="radio" name="state" 
                                                    @if($blog->state==1) @checked(true) @endif
                                                    value="1">
                                                    Publié
                                                </label>
                                                <label class="d-block" for="edo-ani1">
                                                    <input class="radio_animated" id="state1" 
                                                    type="radio" name="state" 
                                                    @if($blog->state==0) @checked(true) @endif
                                                    value="0">
                                                    Non Publié
                                                </label>
                                            </div>
