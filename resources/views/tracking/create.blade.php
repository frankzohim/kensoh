@extends('layouts.app')
@section('title',__('Ajouter un tracking'))
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Ajouter un tracking</h5>
                    </div>
                    <div class="card-body">
                        <form class="row g-3" method="POST" action="{{route('tracking.store')}}">
                            @csrf
                            <div class="col-md-6">
                              <label for="exampleInputName" class="form-label">Date tracking</label>
                              <input type="date" class="form-control" id="date" aria-describedby="NameHelp" value="{{old('date')}}" name="date" required>
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="col-md-6">
                                ...
                                <input type="url" class="form-control" id="link" aria-describedby="NameHelp" name="link" required>
                              </div>
