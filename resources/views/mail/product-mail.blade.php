       ...
       <table align="left" border="0" cellpadding="0" cellspacing="0" style="text-align: left; background-color: #fafafa;" width="100%">
                        ...
                        <tr style="background-color: #fafafa; text-align:center">
                            <td >
                                ...
                                <p style="font-size: 14px;">Une nouvelle personne vient de créer un produit sur votre site web</p>
                                <p style="font-size: 14px;">Ci dessous les informations du produit :</p>
                            </td>
                        </tr>
          </table>
